...
In this course, we'll be building pieces of a pretend social network: LockedIn. LockedIn is a place for professionals to
virtue signal about how all the for-profit work they do is actually an altruistic endeavor. Think Facebook meets a job
fair. It includes tools for influencers to track their growth.


## Instructions

 
- **We need to show our users the accounts they follow with the lowest follower counts.**

<br>

- **This will help them know who they follow that isn't popular enough to be worth following.**
